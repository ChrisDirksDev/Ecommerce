    ...
    <div className="min-h-screen bg-light-beige p-6">
      <div className="max-w-4xl mx-auto bg-white p-6 rounded-2xl shadow-xl">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-cherry text-dark-brown">
            Admin Dashboard
          </h2>
        ...
        <h3 className="text-xl font-quicksand text-dark-brown mb-4">
          Add Product
        </h3>
        ...
        <h3 className="text-xl font-quicksand text-dark-brown mt-8 mb-4">
          Product List
        </h3>
